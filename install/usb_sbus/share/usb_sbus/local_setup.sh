...
: ${AMENT_CURRENT_PREFIX:="/builds/bu/project/tiangong2.0/pro/install/usb_sbus"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/usb_sbus/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/usb_sbus/environment/path.sh"
