...
bool monitor_msgs__msg__proc_cpu_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("monitor_msgs.msg._proc_cpu_data.ProcCpuData", full_classname_dest, 43) == 0);
  }
  monitor_msgs__msg__ProcCpuData * ros_message = _ros_message;
  {  // num
    ...
    ros_message->num = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // used
    ...
    ros_message->used = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ProcCpuData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("monitor_msgs.msg._proc_cpu_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ProcCpuData");
  ...
  {  // used
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->used);
    {
