...
class Metaclass_SetGoal_Request(type):
    ...
    def NONE(self):
        ...
        return Metaclass_SetGoal_Request.__constants['NONE']

    @property
    def UNKNOWN(self):
        """Message constant 'UNKNOWN'."""
        return Metaclass_SetGoal_Request.__constants['UNKNOWN']

    @property
    def GOAL_OCCUPIED(self):
        """Message constant 'GOAL_OCCUPIED'."""
        return Metaclass_SetGoal_Request.__constants['GOAL_OCCUPIED']

    @property
    def TIMEOUT(self):
        """Message constant 'TIMEOUT'."""
        return Metaclass_SetGoal_Request.__constants['TIMEOUT']

    @property
    def NO_VALID_PATH(self):
        """Message constant 'NO_VALID_PATH'."""
        return Metaclass_SetGoal_Request.__constants['NO_VALID_PATH']
...
class Metaclass_SetGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from hric_msgs.srv import _set_goal
...
class SetGoal(metaclass=Metaclass_SetGoal):
    from hric_msgs.srv._set_goal import SetGoal_Request as Request
    from hric_msgs.srv._set_goal import SetGoal_Response as Response
