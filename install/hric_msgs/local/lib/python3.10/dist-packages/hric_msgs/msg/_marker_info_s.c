...
bool hric_msgs__msg__marker_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hric_msgs.msg._marker_info.MarkerInfo", full_classname_dest, 37) == 0);
  }
  hric_msgs__msg__MarkerInfo * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of MarkerInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hric_msgs.msg._marker_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MarkerInfo");
