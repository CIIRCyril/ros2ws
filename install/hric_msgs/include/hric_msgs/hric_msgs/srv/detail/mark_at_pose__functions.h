...
#ifndef HRIC_MSGS__SRV__DETAIL__MARK_AT_POSE__FUNCTIONS_H_
#define HRIC_MSGS__SRV__DETAIL__MARK_AT_POSE__FUNCTIONS_H_
...
/// Initialize srv/MarkAtPose message.
/**
...
/// Finalize srv/MarkAtPose message.
/**
...
/// Create srv/MarkAtPose message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hric_msgs__srv__MarkAtPose_Request__init().
...
/// Destroy srv/MarkAtPose message.
/**
 * It calls
 * hric_msgs__srv__MarkAtPose_Request__fini()
...
/// Check for srv/MarkAtPose message equality.
/**
...
/// Initialize array of srv/MarkAtPose messages.
/**
...
/// Finalize array of srv/MarkAtPose messages.
/**
 * It calls
 * hric_msgs__srv__MarkAtPose_Request__fini()
...
/// Create array of srv/MarkAtPose messages.
/**
 * It allocates the memory for the array and calls
 * hric_msgs__srv__MarkAtPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MarkAtPose messages.
/**
 * It calls
 * hric_msgs__srv__MarkAtPose_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MarkAtPose message array equality.
/**
...
/// Copy an array of srv/MarkAtPose messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hric_msgs__srv__MarkAtPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hric_msgs
...
/**
 * It calls
 * hric_msgs__srv__MarkAtPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hric_msgs
...
/**
 * It allocates the memory for the array and calls
 * hric_msgs__srv__MarkAtPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hric_msgs
...
/**
 * It calls
 * hric_msgs__srv__MarkAtPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HRIC_MSGS__SRV__DETAIL__MARK_AT_POSE__FUNCTIONS_H_
