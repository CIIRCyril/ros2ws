...
#ifndef HRIC_MSGS__SRV__DETAIL__SET_GOAL__FUNCTIONS_H_
#define HRIC_MSGS__SRV__DETAIL__SET_GOAL__FUNCTIONS_H_
 ...
 * calls
 * hric_msgs__srv__SetGoal_Request__init().
...
/**
 * It calls
 * hric_msgs__srv__SetGoal_Request__fini()
 ...
 * hric_msgs__srv__SetGoal_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * hric_msgs__srv__SetGoal_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hric_msgs__srv__SetGoal_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hric_msgs
...
/**
 * It calls
 * hric_msgs__srv__SetGoal_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hric_msgs
...
/**
 * It allocates the memory for the array and calls
 * hric_msgs__srv__SetGoal_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hric_msgs
...
/**
 * It calls
 * hric_msgs__srv__SetGoal_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HRIC_MSGS__SRV__DETAIL__SET_GOAL__FUNCTIONS_H_
