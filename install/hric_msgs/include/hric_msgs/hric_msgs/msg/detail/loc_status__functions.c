...
hric_msgs__msg__LocStatus__init(hric_msgs__msg__LocStatus * msg)
{
  ...
  if (!geometry_msgs__msg__PoseStamped__init(&msg->pose)) {
    hric_msgs__msg__LocStatus__fini(msg);
    return false;
  }
  return true;
}
...
hric_msgs__msg__LocStatus__create()
{
  ...
  hric_msgs__msg__LocStatus * msg = (hric_msgs__msg__LocStatus *)allocator.allocate(sizeof(hric_msgs__msg__LocStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hric_msgs__msg__LocStatus));
  bool success = hric_msgs__msg__LocStatus__init(msg);
  if (!success) {
...
hric_msgs__msg__LocStatus__Sequence__init(hric_msgs__msg__LocStatus__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hric_msgs__msg__LocStatus * data = NULL;

  if (size) {
    data = (hric_msgs__msg__LocStatus *)allocator.zero_allocate(size, sizeof(hric_msgs__msg__LocStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hric_msgs__msg__LocStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        hric_msgs__msg__LocStatus__fini(&data[i - 1]);
      }
...
hric_msgs__msg__LocStatus__Sequence__fini(hric_msgs__msg__LocStatus__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      hric_msgs__msg__LocStatus__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hric_msgs__msg__LocStatus__Sequence * array = (hric_msgs__msg__LocStatus__Sequence *)allocator.allocate(sizeof(hric_msgs__msg__LocStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hric_msgs__msg__LocStatus__Sequence__init(array, size);
  if (!success) {
...
hric_msgs__msg__LocStatus__Sequence__destroy(hric_msgs__msg__LocStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hric_msgs__msg__LocStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hric_msgs__msg__LocStatus__Sequence__are_equal(const hric_msgs__msg__LocStatus__Sequence * lhs, const hric_msgs__msg__LocStatus__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hric_msgs__msg__LocStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hric_msgs__msg__LocStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hric_msgs__msg__LocStatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    hric_msgs__msg__LocStatus * data =
      (hric_msgs__msg__LocStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hric_msgs__msg__LocStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          hric_msgs__msg__LocStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!hric_msgs__msg__LocStatus__copy(
