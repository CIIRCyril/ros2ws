...
: ${AMENT_CURRENT_PREFIX:="/builds/bu/project/tiangong2.0/pro/install/xsys"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/xsys/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/xsys/environment/path.sh"
