...
#ifndef XSYS_MSGS__SRV__DETAIL__GET_SERIAL_NUMBER__FUNCTIONS_H_
#define XSYS_MSGS__SRV__DETAIL__GET_SERIAL_NUMBER__FUNCTIONS_H_
...
#include "xsys_msgs/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_xsys_msgs
bool
 ...
 * calls
 * xsys_msgs__srv__GetSerialNumber_Request__init().
...
/**
 * It calls
 * xsys_msgs__srv__GetSerialNumber_Request__fini()
 ...
 * xsys_msgs__srv__GetSerialNumber_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * xsys_msgs__srv__GetSerialNumber_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * xsys_msgs__srv__GetSerialNumber_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_xsys_msgs
...
/**
 * It calls
 * xsys_msgs__srv__GetSerialNumber_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_xsys_msgs
...
/**
 * It allocates the memory for the array and calls
 * xsys_msgs__srv__GetSerialNumber_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_xsys_msgs
...
/**
 * It calls
 * xsys_msgs__srv__GetSerialNumber_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // XSYS_MSGS__SRV__DETAIL__GET_SERIAL_NUMBER__FUNCTIONS_H_
