...
: ${AMENT_CURRENT_PREFIX:="/builds/bu/project/tiangong2.0/pro/install/audio"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/audio/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/audio/environment/path.sh"
