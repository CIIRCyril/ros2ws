...
: ${AMENT_CURRENT_PREFIX:="/builds/bu/project/tiangong2.0/pro/install/rl_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rl_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rl_control/environment/path.sh"
